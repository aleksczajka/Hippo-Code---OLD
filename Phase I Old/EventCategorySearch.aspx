...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="EventDiv" style="float: left;"><h1 style="margin: 0;"><asp:Label Width="418px" 
        runat="server" CssClass="EventHeader" ID="SearchResultsTitleLabel"></asp:Label></h1>
            ...
            style="color: #999999; font-family: Arial; width: 418px; font-size: 12px; padding-bottom: 10px;">
                ...
                this category that have already happened, please use the event search page.]<br />
            </div><div 
            align="right" style="color: #999999; font-family: Arial; width: 418px; font-size: 12px;">
