...
CodeFile="AdSearch.aspx.cs" Inherits="AdSearch" Title="Search local ads & classifieds | HippoHappenings " %>
...
--%>                                    <asp:Panel ID="Panel2" runat="server"  DefaultButton="SearchButton">
                                       ...
                                       <tr>
                                        <td>
                                            <label><span style="color: #f6af6f; font-weight: bold;">What City, State or Zip are you searching in?</span> </label><br />
                                            ...
                                            AllowCollapseAllItems="true" ExpandMode="SingleExpandedItem">
                                                <Items>
                                                    <rad:RadPanelItem Expanded="true" Text="<div style='color: #cccccc; font-weight: bold; text-align: center;height: 10px; '>Using Only City and State</div>">
                                                       ...
                                                       <rad:RadPanelItem Text="<div style='color: #cccccc; font-weight: bold;height: 40px; text-align: center;'><span style='color: #f6af6f; font-weight: bold; font-size: 18px;'>OR</span> <br/>Using Only Zip and Radius</div>">
                                                        <Items>
                                                            <rad:RadPanelItem runat="server" Expanded="false">
                                                                <Items>
                                                                    <rad:RadPanelItem BackColor="#393939"></rad:RadPanelItem>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="padding-bottom: 10px;padding-top: 10px;"><label><span style="color: #f6af6f; font-weight: bold;">Give us some distinguishing keywords (ex: part of a name)</span></label></div>
                                          ...
                                          <div style="padding-bottom: 5px;">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                <div style="padding-bottom: 5px;padding-top: 10px;"><label><span style="color: #f6af6f; font-weight: bold;">What type of classifieds are you looking for?</span></label></div>
