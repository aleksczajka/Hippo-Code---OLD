...
Title="Local events, venues, groups, classifieds in your community and neighborhood. Find hip happenings | HippoHappenings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:Label runat="server" ID="ErrorLabel" ForeColor="red"></asp:Label>  
               ...
               <div style="margin-left: 7px;">
                    ...
                    <tr>
                        ...
                        <%--<asp:Timer ID="MissionTimer" OnTick="ChangeMission" runat="server" Interval="15000">
                            ...
                            <div style="font-size: 12px; color: #e5e3e3; padding-right: 20px; padding-left: 15px;">
                                <ul style="margin: 0px;">
                                    
                                    <li style="padding-bottom: 13px;">
                                        Post <a class="AddLink" style="text-decoration: underline;" href="BlogEvent.aspx">Events</a> to share happenings at local <a class="AddGreenLink" style="text-decoration: underline;" href="EnterVenue.aspx">Venues</a>.
                                    </li>
                                    <li style="padding-bottom: 13px;">
                                        Use <a class="AddPurpleLink" style="text-decoration: underline;" href="GroupsLanding.aspx">Groups</a> for parties, meet-ups and groups.
                                    </li>
                                    <li style="padding-bottom: 13px;">
                                        Post <a class="AddOrangeLink" style="text-decoration: underline;" href="PostAnAd.aspx">Classifieds</a> to promote your event, local business, garage sale, or anything.
                                    </li>
                                    <li style="padding-bottom: 13px;">
                                        Everything is free except posting featured ads on the 
                                        'Local ad/bulletin board' (also free for time being).
                                    </li>
                                    <li>
                                        <span style="font-style: italic;">We <b>NEVER</b> Share nor Sell any of your information!
                                        </span>
                                    </li>
                                    
                                </ul>
                                <a href="About.aspx" style="padding-top: 10px;font-weight: bold;font-style: italic;float: right; color: #8bbccc; font-size: 14px;padding-right: 35px;">Learn More</a>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2"  style="padding-top: 5px;">
                            <div style="background-image: url(images/TwistedLogin.png); background-repeat: no-repeat; width: 879px; height: 79px; padding-top: 25px; padding-left: 65px;">
                                <a href="UserLogin.aspx" 
                                style="padding-right: 50px;float: left; color: #8bbccc; font-size: 18px; font-style: italic;">Log In</a>
                                <a href="Register.aspx" 
                                style="float: left; color: #7fa23c; font-size: 18px; font-style: italic;">Register</a>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <div style="float: right; padding-right: 12px;  width: 419px; padding-top: 30px;">
            ...
            <div style="margin-left: -8px; width: 419px; padding-top: 30px;">
            <div runat="server" style="width: 430px;height: 10px;background-image: url('images/ActivityTop.png'); background-repeat: no-repeat; background-position: top left;">
            </div>
                <div class="topDiv" style="width: 430px;padding-left: 25px;background-image: url('images/ActivityMiddle.png'); background-repeat: no-repeat; background-repeat: repeat-y;">
                    <div style="padding-bottom: 5px;"><asp:Label runat="server" CssClass="PreferencesTitleAlt" ForeColor="#999999" ID="GroupsLabel" 
                    Text="Latest Public Group Activity in Your Area"></asp:Label></div>
                    <asp:Panel runat="server" ID="GroupsPanel"></asp:Panel>
                 </div>
                <div style="width: 430px;height: 15px;background-image: url('images/ActivityBottom.png'); background-position: top left; background-repeat: no-repeat;">
                </div>
            </div>
