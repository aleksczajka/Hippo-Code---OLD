<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="User_OLD.aspx.cs" 
        ...
        <div style="float: left; width: 420px; padding-bottom: 15px;margin-top: -20px;">
          ...
          <%--  <asp:Panel Visible="false" runat="server" ID="FriendMessagesPanel" Width="440px" ScrollBars="Vertical">
            ...
            <div style="clear: both;">
                <asp:Panel Visible="false" Height="100px" ScrollBars="Vertical" runat="server" ID="GroupUpdatesPanel"></asp:Panel>
            </div>
 ...
 /></div>
                            ...
                            <a id="groups"></a>
                                <asp:UpdatePanel runat="server" UpdateMode="conditional">
                                    ...
                                    <div style="height: 45px; margin-top: 139px; background-color: #363636; 
                                    width: 7px; float: left;"></div>
                                    <div class="EventDiv" style="padding: 10px;border: solid 3px #363636; margin-top: 1px; float: left; width: 550px;">
    ...
    <div class="topDiv">
        ...
        <div style="position: absolute; top: 745px;" class="topDiv">
            ...
            <rad:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0">
                    <rad:RadPageView  BackColor="#363636" runat="server"  Width="280px" ID="RadPageView1" TabIndex="0">
                ...
                <rad:RadPageView runat="server"  BackColor="#363636"  Width="280px" ID="RadPageView2" TabIndex="1">
