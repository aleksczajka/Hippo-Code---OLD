...
AutoEventWireup="true" CodeFile="AdStatistics_TEST.aspx.cs" Inherits="AdStatistics_TEST"
                ...
                <td style="padding-top: 60px;">
                    <div class="EventDiv" style="color: #cccccc;">
                        ...
                        <asp:UpdatePanel runat="server" UpdateMode="conditional">
                            <ContentTemplate>
                                <asp:Literal runat="server" ID="ListofUsersLiteral"></asp:Literal>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        <%--<asp:UpdatePanel runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Label runat="server" ID="ErrorLabel" ForeColor="Red"></asp:Label>
                                <asp:GridView AllowSorting="true" AutoGenerateColumns="false" OnSorting="gv_Sorting" 
                                runat="server" ID="gv">
                                    <Columns>
                                        <asp:BoundField
                                            DataField="Reason For View [Location Only, Non-Assigned User or list of Categories]"
                                            HeaderText="Reason For View [Location Only, Non-Assigned User or list of Categories]"
                                            ShowHeader="True"
                                            SortExpression="Reason">
                                        </asp:BoundField>
                                        <asp:BoundField
                                            DataField="Date"
                                            HeaderText="Date of View"
                                            ShowHeader="True"
                                            SortExpression="Date">
                                        </asp:BoundField>
                                    </Columns>
