...
CodeFile="GroupSearch_OLD.aspx.cs" Inherits="GroupSearch" Title="Search local groups | HippoHappenings " %>
...
<div style="float: left;" class="EventDiv">
    <div style="background-repeat: no-repeat; padding-left: 20px; padding-top: 25px;width: 448px; height: 60px; margin-top: -28px; margin-left: -20px;">
        ...
        <div style="margin-top: -5px; line-height: 20px;width: 130px; float: right; padding-right: 45px; font-family: Arial; font-size: 11px; color: White;">
            ...
            <a style="color: White;text-decoration: none;" href="User.aspx?G=true#groups">Configure group <span style="color: #A76CC7;">Settings</span> </a>
        </div>
    </div>
                                ...
                                <div style="float: right;">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                <div style="padding-bottom: 5px;"><label><span style="color: #A5C13A; font-weight: bold;">What type of groups are you looking for?</span></label></div>
                                                    <div class="EventDiv" style="border: solid 3px #A76CC7;background-color: #333333; width: 420px; padding-left: 5px; padding-top: 5px; color: #cccccc; min-height: 200px;">
                                                    <table>
                                                        <tr>
                                                            <td valign="top">
