...
CodeFile="EnterEvent.aspx.cs" Inherits="EnterEvent" Title="Enter Event | HippoHappenings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div id="topDiv2" style="width: 870px;">
    <div id="topDiv" class="RegisterDiv" style="float: left; width: 440px;"><span style="font-family: Arial; font-size: 30px; color: #666666;"><asp:Label runat="server" ID="EventTitle"></asp:Label></span><br />
         <br />
