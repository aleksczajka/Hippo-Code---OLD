...
CodeFile="Home_TEST.aspx.cs" Inherits="Home_TEST" smartnavigation="true"
               ...
               <div style="margin-left: 7px;">
                    ...
                    <tr>
                        ...
                        <%--<asp:Timer ID="MissionTimer" OnTick="ChangeMission" runat="server" Interval="15000">
                            ...
                            <div style="font-size: 12px; color: White; padding-right: 20px; padding-left: 15px;">
                                <ul style="margin: 0px; padding-top: 20px;">
                                    <li style="padding-bottom: 15px;">
                                        <a href="HalloweenLanding.aspx" style="text-decoration: none;font-size: 18px; font-style: italic; font-weight: 
                                        bold; color: rgb(127, 162, 60);"><span style="color: rgb(255, 107, 9);">
                                        Halloween</span> The Hippo Way!</a> 
                                    </li>
                                    <li style="padding-bottom: 15px;">
                                        Post Events to share local happenings at local Venues
                                    </li>
                                    <li style="padding-bottom: 15px;">
                                        Use Classifieds to promote your Event, local business, garage sale, etc.
                                    </li>
                                    <li style="padding-bottom: 15px;">
                                        Use Groups for any gatherings. Set up events for gatherings through the group page.
                                    </li>
                                </ul>
                                <a href="About.aspx" style="font-weight: bold;font-style: italic;float: right; color: #8bbccc; font-size: 14px;padding-right: 35px;">Learn More</a>
                            </div>
                        </td>
