...
<%@ Register Src="~/Controls/Pager_TEST.ascx" TagPrefix="ctrl" TagName="Pager" %>
...
//            }
    ...
    <rad:RadWindowManager Behaviors="Close"
            ...
            <Windows>
                ...
                VisibleOnPageLoad="false" Height="500" ClientCallBackFunction="OnClientClose" Width="750px" 
                Skin="Black"
   ...
   <telerik:RadWindowManager ShowContentDuringLoad="true" VisibleTitlebar="true" 
            ...
            runat="server">
                <Windows>
                    ...
                    <telerik:RadWindow Width="300" ClientCallBackFunction="DoFillGroups" 
                    ...
                    EnableEmbeddedSkins="true" 
                    VisibleTitlebar="false"
                    VisibleStatusbar="false" Skin="Black" Height="200" ID="RadWindow3" 
                    Title="Alert" runat="server">
                    </telerik:RadWindow>
                </Windows>
            </telerik:RadWindowManager>
        <div style="float: left; width: 435px; padding-bottom: 10px;margin-top: -35px;">
            <div class="topDiv">
          ...
          <%--  <asp:Panel Visible="false" runat="server" ID="FriendMessagesPanel" Width="440px" ScrollBars="Vertical">
            ...
            <div class="topDiv EventDiv" style="width: 430px;">
                    ...
                    <div style="padding-top: 5px;border-bottom: solid 1px black;">
                        <asp:Panel Visible="false" Height="176px" ScrollBars="Vertical" runat="server" 
                        ...
                        <td valign="top">
                            ...
                            ID="RadTabStrip2" Skin="Black"
                             ...
                             OnClientMouseOver="onTabMouseOver"
                               style="float:left">
                                <Tabs>
                                    <rad:RadTab CssClass="MyTabsMessagesSelected" Width="280px" 
            ...
            <td valign="top">
                     <rad:RadMultiPage ID="TheMultipage" 
                         SelectedIndex="0" runat="server" >
                            <rad:RadPageView ID="Tab1" TabIndex="0" runat="server">
                               <script type="text/javascript" language="javascript">
                                ...
                                <div style="float: left; width: 575px;"> 
                                   <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="conditional" ChildrenAsTriggers="true">
                                                    ...
                                                    <ContentTemplate>
                                                    <div style="z-index: 3000;float: right; position: relative; top: 30px;"><asp:LinkButton ID="LinkButton1" OnClientClick="if(confirm('Are you sure you want to delete these messages? Deletion will happen from messages you have checked in your Inbox and Send Messages.')){ShowLoadingCalendar(); return true;}else{return false;}" CssClass="AddLink" OnClick="DeleteMessages" runat="server" Text="delete checked messages"></asp:LinkButton></div>
                                  ...
                                  <div style="width: 575px; display: block; float: left;">
                                        ...
                                        <div align="center" id="Div1"  style="display: none;z-index: 3000;position: absolute; width: 575px;" >
                                            ...
                                            <div class="topDiv" id="MessagesDiv">
                            ...
                            <rad:RadPageView ID="Tab2" TabIndex="1" runat="server" >
                            ...
                            <rad:RadPageView ID="Tab3" TabIndex="2" runat="server" >
                            <a id="pfs"></a>
 ...
 /></div>
                                        <div class="Prefs EventDiv" style="width: 560px; display: block; float: left; margin-left: 5px; padding-top: 5px;">
                                            ...
                                            <div style="border-bottom: dotted 1px black;">
                                                <asp:Label ID="Label12" runat="server" Text="Name" CssClass="PreferencesTitle"></asp:Label><span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;"> (Your name is only used to help your friends find you on the site. It is not necessary to include your name here. Friends will still be able to find you by your user name.)</span>
                                            </div>
                                            ...
                                            <div style="border-bottom: dotted 1px black;">
                                                ...
                                                <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;"> (Events and Ads 
                                                are filtered based on location. You will still be able to search on everything else, 
                                            ...
                                            <div style="clear: both;"  class="Pad">
                                                <div style="float:left;">
                                                    <asp:RadioButtonList runat="server" ID="PublicPrivateCheckList">
                                                        <asp:ListItem Value="1">Make Public <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(your events and your full profile will be viewable by everyone)</span></asp:ListItem>
                                            ...
                                            <div  class="Pad">
                                                <asp:RadioButtonList runat="server" ID="CommunicationPrefsRadioList">
                                                    <asp:ListItem Value="1">On for Everyone <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(this means users can contact you to carpool, etc. when you have added an event to your calendar. Great choice for meeting new friends!)</span></asp:ListItem>
                                ...
                                <table height="100%">
                                           ...
                                           <%-- <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both;">
                                                <asp:Label ID="Label3" runat="server" CssClass="PreferencesTitle"> Event Recommendations Preferences <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(Show recommend events in the <b>User Page</b> and in the <b>Footer</b> when they are ...)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both;">
                                                <asp:Label ID="Label4" runat="server" CssClass="PreferencesTitleAlt"> Billing Address <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(this is only used for purchased ads on the site)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                                <table>
                                                    <tr>
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label5" runat="server" CssClass="PreferencesTitle"> Phone Number & Provider <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(this is only used for texting event info)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                                <table>
                                                    <tr>
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label6" runat="server" CssClass="PreferencesTitleAlt"> Texting Preferences <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(send notifications to your phone when...)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label10" runat="server" CssClass="PreferencesTitle"> Email Preferences <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(send notifications to your email address when...)</span></asp:Label>
                                            </div>
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label9" runat="server" CssClass="PreferencesTitleAlt"> Comments Preferences <span style="font-style: italic; font-family: Arial; font-size: 12px; color: #cccccc;">(The comment list for events, venues, etc. can get long. You can decrease it's size by selecting to only view your friends' comments.)</span></asp:Label>
                                            </div>
                                            <div style="clear: both;"  class="Pad">
                                                <div style="float:left;">
                            ...
                            <rad:RadPageView ID="Tab4" TabIndex="3" runat="server" >
                            <a id="groups"></a>
