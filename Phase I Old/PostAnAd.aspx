 ...
 <rad:RadWindowManager ShowContentDuringLoad="true" VisibleTitlebar="false" 
            ...
            runat="server">
                <Windows>
                    ...
                    VisibleStatusbar="false" NavigateUrl="MeaslesChart.aspx" Skin="Black" 
                    Height="530" ID="RadWindow1" Title="Alert" runat="server">
                    </rad:RadWindow>
                </Windows>
            </rad:RadWindowManager>
...
--%>    <asp:Panel runat="server" ID="LogInPanel" Visible="false">
    ...
    <tr>
        <td width="200px">
                <div style="font-family: Arial; font-size: 30px; color: White;"> 
    ...
    <asp:Panel runat="server" ID="IntroPanel">
     <div class="EventDiv" style="width: 300px; float: right;">
             ...
             href="termsAndConditions.aspx">terms of use</a> and <a class="AddLink" href="about.aspx#tag16">about page</a>.
             </label>--%>
         </div>
        <div style="font-family: Arial; font-size: 30px; color: #cccccc; padding-bottom: 10px;">
            ...
            <div class="topDiv">
                <div style="float: left; padding-right: 47px; padding-top: 5px;">
                    <span style="font-family: Arial; font-size: 14px; color: White;">What are you looking to do?</span>
                </div>
                <div style="float: left;">
                    <div class="GreenButton"  
                    onmouseover="this.style.backgroundImage='url(image/GreenButtonSelected.png)'"  
                    onclick="OpenRadBefore_Measles()" 
                    onmouseout="this.style.backgroundImage='url(image/GreenButton.png)'" >
                    Understanding The Differences</div>
                </div>
            </div>
            
<%--            <asp:Panel runat="server" ID="FreeFeaturedAdsPanel" Visible="false">                    <img src="image/TheStar5.png" width="50px" height="50px" /><span style="color: White; font-weight: bold;">Featured classifieds are now free!</span>                </asp:Panel>
--%>            <div style="margin-top: 40px; padding-left: 5px; margin-left: 30px;font-family: Arial; 
            font-size: 12px; color: White;background: url('image/FeaturedBackground.png'); width: 750px; 
            height: 110px; background-repeat: no-repeat;">
                <div class="topDiv" style="height: 100px;">
                    <div style="float: left; text-align: center;padding-top: 35px; padding-left: 13px;padding-right: 10px;">
                        <img src="image/PostFeaturedText.gif" /><br />
                        <asp:Panel runat="server" ID="FreeFeaturedAdsPanel" Visible="false">
                            <span style="font-family: Arial; color: #02d201; font-size: 12px; font-weight: bold;">
                            All featured ads are now FREE</span>
                        </asp:Panel>
                    </div>
                    <div style="float: left;padding-top: 31px; padding-right: 44px;">
                        <asp:ImageButton runat="server" ID="ImageButton2" ImageUrl="~/image/FeaturedAdButton.png"  
                        onmouseout="this.src='image/FeaturedAdButton.png'" OnClick="SelectFeaturedPanel" 
                        onmouseover="this.src='image/FeaturedAdButtonSelected.png'"   />
                    </div>
                    <div style="float: left; padding-top: 4px;">
                        <div>
                            You Get: <br />                            <ul style="color: #02d201; font-size: 12px; line-height: 18px; margin-top: 0;">                                <li  style="color: #93fd7b">                                    <span style="color: #cccccc;">Your classified viewed throughout the site</span>                                </li>                                <li>                                    <span style="color: #cccccc;">Statistics on your viewed ads</span>                                </li>                                <li style="color: #93fd7b">                                    <span style="color: #cccccc;">Ability for users to receive                                     your ad straight to email</span>                                </li>                                <li>                                    <span style="color: #cccccc;">Choose how many users                                     view your ad: <span style="text-decoration: line-through;">only $0.01 / user</span><span style="font-family: Arial; color: #02d201; font-size: 12px; font-weight: bold;">
                                            Now Free!</span></span>                                </li>                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <div style="margin-top: 67px; padding-left: 5px; margin-left: 30px;
            font-family: Arial; font-size: 12px; color: White;background: url('image/FreeBackground.png'); 
            width: 700px; height: 110px; background-repeat: no-repeat;">
                <div class="topDiv" style="width: 400px; margin-left: 23px;">
                     <div style="float: left;padding-right: 53px; margin-top: 43px; ">
                        <img src="image/PostFreeText.gif" />
                     </div>
            ...
            <div class="EventDiv" style="padding-top: 40px; padding-left: 20px;">
                <div>
                    <span style="font-size: 12px; color: #cccccc;">*Read our <a class="AddLink" href="TermsAndConditions.aspx">Terms of Use</a> and <a class="AddLink" href="ProhibitedAds.aspx">Prohibited Ads</a> pages, 
                    especially if you are a big corporation*</span>
                </div>
                                ...
                                <asp:Panel runat="server" ID="Panel1" DefaultButton="DetailsOnwardsButton">
                                    ...
                                    <div id="topDiv3" style="background: url('image/TabsBackground.png'); background-repeat: repeat-y; width: 668px; padding-top: 10px;">
                                        <div class="EventDiv" style="padding-left: 30px; float: left; padding-bottom: 10px; margin-right: 50px;">
                                            <h1>Details</h1>
                                            <div id="topDiv" style="padding-left: 20px;">
                                            
                                                <div style="float: left; width: 330px;">
                                                <span style="font-size: 10px; color: #cccccc;">All HTML tags will be removed except for links 
                                                and line breaks. However, the header cannot contain any html.</span>
                                                <br /><br />
...
//                                                                            }  
                                                        function CountCharsHeadline(editor, e){
                                                                ...
                                                                var theText = document.getElementById("ctl00_ContentPlaceHolder1_AdNameTextBox_TheTextBox");
                                                                theDiv.innerHTML = "characters left: "+ (70 - theText.value.length).toString();
                                                            
                                                        }
                                                    </script>
                                                    <span style="font-family: Arial; font-size: 10px; font-weight: bold; color: #ff770d;">max 70 characters &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    &nbsp;&nbsp;<span style="color: Red;" id="CharsDivHeadline"></span></span>
                                                    <ctrl:HippoTextBox runat="server" ON_CLIENT_KEYPRESS="CountCharsHeadline(event)" ID="AdNameTextBox" TEXTBOX_WIDTH="300" CSS_CLASS="TextBox25" LITERAL_CSS_CLASS="TextBoxLeftImage25" />
                                                   <br /><br /><br />
                                                        ...
                                                        <div style="float: left;">
                                                         ...
                                                         ShowEvent="onclick" Position="MiddleRight" RelativeTo="Element" TargetControlID="Image3">
                                                            ...
                                                            This text is what people will read when they visit your ad page, so be as descriptive as you need to be.
                                                                ...
                                                                <br />
                                                                <span style="font-family: Arial; font-size: 10px; font-weight: bold; color: #ff770d;">
                                                                max 1000 characters &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
--%>                                                    </div>
                                                    ...
                                                    <%--<asp:TextBox  runat="server" Height="100px" TextMode="MultiLine" 
                                                    ID="DescriptionTextBox"  Width="300px"></asp:TextBox>--%>
                                                    <script type="text/javascript">
...
--%>                                                         <%-- <rad:RadEditor OnClientLoad="OnClientLoad" EditModes="Design" Skin="Black" runat="server" 
                                                    ...
                                                    <rad:RadEditor EditModes="Design" OnClientLoad="OnClientLoad" Skin="Black" runat="server" 
                                                    ...
                                                    <label><span style='color: #ff770d; font-weight: bold; font-size: 10px;'><span style='color: #1fb6e7; font-weight: bold;'>* </span>required fields</span></label>
                                                </div>
                                             ...
                                             ShowEvent="onclick" Position="MiddleRight" RelativeTo="Element" TargetControlID="Image2">
                                                ...
                                                <asp:Panel runat="server" ID="NormalStartDatePanel">
                                                    ...
                                                    <asp:Panel runat="server" ID="DaysExplanationPanel" Width="200px" Visible="false">
                                                        <span style="font-size: 10px; color: #cccccc;"><span style='color: #1fb6e7; font-weight: bold;'>* </span>The length 
                                                        of time your featured ad runs will be determined later on by the number of 
                                                        views you request.</span>
                                                    </asp:Panel>
                                                </div>
                                            </div>
                                            ...
                                            <div class="topDiv" style="clear: both; width: 500px;">
                                                <div style="float: left; padding-left: 50px;">
                                                    ...
                                                    <asp:Button runat="server" ID="MusicUploadButton" Text="Upload!" 
                                                     CssClass="SearchButton"  PostBackUrl="PostAnAd.aspx"
    ...
    <%--                                                    <asp:ImageButton runat="server" ID="MusicUploadButton" 
                                                         OnClick="MusicUpload_Click" PostBackUrl="PostAnAd.aspx"
    ...
    --%>                                                </div>
                                            ...
                                            <div style="padding-left: 50px; width: 632px; clear: both; padding-top: 10px;">
                                                                            ...
                                                                            <div id="Div1" class="topDiv">
                                                                                ...
                                                                                <asp:Button runat="server" ID="ImageButton1" Text="Upload!" 
                                                                                   ...
                                                                                   <%-- <asp:ImageButton runat="server" ID="ImageButton1" 
                                                                                    PostBackUrl="PostAnAd.aspx" OnClick="PictureUpload_Click"
                                                                                     ImageUrl="image/MakeItSoButton.png" 
                                                                        ...
                                                                        <%--<asp:Panel runat="server" ID="UploadPanel" Visible="false">
                                                                            <div id="Div2">
                                                                                ...
                                                                                <asp:ImageButton runat="server" ID="ImageButton4" 
                                                                                    PostBackUrl="PostAnAd.aspx" OnClick="VideoUpload_Click"
                                                                                     ImageUrl="image/MakeItSoButton.png" 
                                                                                    onmouseout="this.src='image/MakeItSoButton.png'" onmouseover="this.src='image/MakeItSoButtonSelected.png'"  />
                                                                                </div>
                                                                            </div>
     ...
     <%--                                                                               <asp:ImageButton runat="server" ID="ImageButton10" 
                                                                                        PostBackUrl="PostAnAd.aspx" OnClick="YouTubeUpload_Click"
                                                                                         ImageUrl="image/MakeItSoButton.png" 
                                                                                        onmouseout="this.src='image/MakeItSoButton.png'" onmouseover="this.src='image/MakeItSoButtonSelected.png'"  />
    --%>                                                                            </div>
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <%--<div id="Div3" style=" padding-left: 30px; clear: both; padding-top: 10px;">
                                                                            ...
                                                                            <asp:ImageButton runat="server" ID="ImageButton14" 
                                                                                PostBackUrl="PostAnAd.aspx#top" OnClick="SliderUpload_Click"
                                                                                 ImageUrl="image/MakeItSoButton.png" 
                                                                                onmouseout="this.src='image/MakeItSoButton.png'" onmouseover="this.src='image/MakeItSoButtonSelected.png'"  />
                                                                            </div>
                                                                        </div>--%>
                                        ...
                                        <div class="EventDiv">
                                            ...
                                            <asp:UpdatePanel runat="server" UpdateMode="conditional">
                                                ...
                                                <div style="padding-left: 30px; width: 632px; clear: both; padding-top: 10px;">
                                                    ...
                                                    <h1>Ad Media</h1>
                                                        <div class="topDiv">
                                                        <div style="margin-left: 20px; float: left;padding-top: 3px;">
                                                            <label><span style="font-weight: bold;">Select 
                                                            your Ad Placement</span></label>
                                                        </div>
                                                        ...
                                                        <div style="padding-left: 40px;">
                                                            ...
                                                            <script type="text/javascript">
                                                                function changeBig()
                                                                {
                                                                    __doPostBack('ctl00$ContentPlaceHolder1$ChangeMaxText', '');
                                                                }
                                                                function ChangeFetText()
                                                                {
                                                                    __doPostBack('ctl00$ContentPlaceHolder1$ChangeMaxText', '');
                                                                }
                                                            ...
                                                            <div >
                                                                <asp:RadioButtonList AutoPostBack="true" OnSelectedIndexChanged="ChangeFeaturedText" runat="server" ID="AdPlacementList" >
                                                        ...
                                                        <div style="margin-left: 15px;">
                                                            ...
                                                            ID="BannerAdCheckBox" Text="<span style='font-weight: bold;'>Include a Banner Image</span>" />
                                                        </div>
                                                        <asp:Panel runat="server" ID="AdMediaPanel" Visible="false" Enabled="false">
                                                            <div style="margin-left: 30px;">
                                                                ...
                                                                <div style="margin-left: 20px;">
                                                                    <%--<asp:UpdatePanel runat="server" UpdateMode="conditional">
                                                                        <ContentTemplate>--%>
                                                                            <asp:LinkButton runat="server" ID="ChangeBigSmall" OnClick="ChangeFeaturedText"></asp:LinkButton>
                                                                            <div>
                                                                                <asp:Panel runat="server" ID="SmallPanel">
                                                                                       ...
                                                                                       <asp:RadioButtonList AutoPostBack="true" OnSelectedIndexChanged="ChangeFeaturedText" CssClass="AdTemplates" runat="server" ID="TemplateRadioList" RepeatDirection="Horizontal">
                                                                                            <asp:ListItem Value="1" Selected="true" Text="<div style='float: right;'><img src='../images/QuarterTemplate.gif'/></div>"></asp:ListItem>
                                                                                            <asp:ListItem Value="2" Text="<div style='float: right;'><img src='../images/HalfTemplate.gif'/></div>"></asp:ListItem>
                                                                                            <asp:ListItem Value="3" Text="<div style='float: right;'><img src='../images/FullTemplate.gif'/></div>"></asp:ListItem>
                                                                                       </asp:RadioButtonList>
                                                                                </asp:Panel>
                                                                                <asp:Panel runat="server" ID="BigPanel" Visible="false">
                                                                                       <asp:RadioButtonList AutoPostBack="true" OnSelectedIndexChanged="ChangeFeaturedText" CssClass="AdTemplates" runat="server" ID="RadioButtonList1" RepeatDirection="Horizontal">
                                                                                            <asp:ListItem Value="1" Selected="true" Text="<div style='float: right;'><img src='../images/HalfBigTemplate.gif'/></div>"></asp:ListItem>
                                                                                            <asp:ListItem Value="2" Text="<div style='float: right;'><img src='../images/FullBigTemplate.gif'/></div>"></asp:ListItem>
                                                                                       </asp:RadioButtonList>
                                                                                </asp:Panel>
                                                                            </div>
                                                                       <%-- </ContentTemplate>
                                                                ...
                                                                <div style="margin-left: 20px;">
                                                                    ...
                                                                    <asp:Button runat="server" ID="ImageButton5" Text="Upload!" 
                                                                         CssClass="SearchButton"  PostBackUrl="PostAnAd.aspx#top"
            ...
            <%--                                                            <asp:ImageButton runat="server" ID="ImageButton5" 
                                                                        PostBackUrl="PostAnAd.aspx#top" OnClick="AdPictureUpload_Click"
                                                                         ImageUrl="image/MakeItSoButton.png" 
                                                                        onmouseout="this.src='image/MakeItSoButton.png'" 
                                                                        onmouseover="this.src='image/MakeItSoButtonSelected.png'"  />
            --%>                                                        </div>
...
--%>                                                                <asp:LinkButton runat="server" ID="ChangeMaxText" OnClick="ChangeFeaturedText"></asp:LinkButton>
                                                                <label><span style='color: #1fb6e7; font-weight: bold;'>* </span><span style="font-weight: bold;">Enter the Featured Ad Summary</span> </label>&nbsp;&nbsp;
                                                         ...
                                                         ShowEvent="onclick" Position="MiddleRight" RelativeTo="Element" TargetControlID="Image4">
                                                            <label>
                                                                ...
                                                                It needs to be short enough to fit in the ad.  <span style='color: #ff770d;'>No line breaks or links are allowed.</span></label>
                                                            </rad:RadToolTip>
                                                                <br />
            ...
            //                                                                            }  
                                                                        ...
                                                                        style=" padding: 3px;font-family: Arial; font-size: 12px; color: #cccccc ;border: 0;
                                                                        background-color: #686868;width: 200px; height: 100px;" 
...
--%>    <%--                                                    <asp:TextBox runat="server" ID="SummaryTextBox" Width="200" Height="100" TextMode="multiLine" Wrap="true"></asp:TextBox>
    --%>                                                <hr />
    <asp:CheckBox runat="server" ID="AllLocationCheckBox" 
                                                        Checked="true" Text="Show outside of location if viewer has space available." />
                                                        <asp:Image CssClass="HelpImage" runat="server"  ID="Image7" 
                                                        ImageUrl="~/image/helpIcon.png"></asp:Image>
                                                            <br /><br />
                                                              <rad:RadToolTip ID="RadToolTip12" runat="server" Skin="Black" 
                                                              Width="200px" Height="200px" ManualClose="true" ShowEvent="onclick" 
                                                              Position="MiddleRight" RelativeTo="Element" TargetControlID="Image7">
                                                                <label>Many times there are viewers that use our site that have 
                                                                never signed up for an account, therefore we cannot associate 
                                                                them with a specific location. If you would like your ad to be 
                                                                shown to these viewers as well, please let us know by checking the box.</label>
                                                        </rad:RadToolTip><br />
    ...
    --%>                                 
                                        <div style=" width: 550px; clear: both;" class="topDiv">
                                            ...
                                            <div style="padding-top: 16px; float: left; padding-left: 10px;">
                                                <asp:LinkButton runat="server" ID="ImageButton11" 
                                                    OnClick="SuggestCategoryClick" Text="Suggest" CssClass="AddLink" 
                                                    onmouseout="this.src='image/MakeItSoButton.png'" 
                                                    onmouseover="this.src='image/MakeItSoButtonSelected.png'"></asp:LinkButton>
                                            </div>
                                        </div>
                                         
                                         <asp:Panel runat="server" ID="CatDisplayPanel" Visible="false">
                                         <div style=" width: 587px; padding-top: 10px;">
                                         <hr />
                                        <label>Do you want your ad to display to non-selected categories? <asp:Image CssClass="HelpImage" runat="server"  ID="QuestionMark3" ImageUrl="~/image/helpIcon.png"></asp:Image></label>
                                            ...
                                            <label>Your ad will be shown to people in the categories you specify first. 
                                            However, you can also choose to display the ad in categories you have not selected. 
                                            This means your ad will be shown to people who are sign in but haven't chosen their 
                                            favorite categories or chose categories that simply do not have many ads assigned to them.
                                            <br />We have added this choice for ads in categories that not many people select as 
                                            their favorite. Utlimately, you could be waiting a long time for your ad to be show to 
                                            the number of users you specify.
                                             </label>
                                            </rad:RadToolTip>
                                            <hr />
                                            </div>
                                      ...
                                      <Triggers>
                                       ...
                                       <%--<hr />
                                        ...
                                        <label>The total number of users you have chosen is calculated by first selecting all users in your selected location. From these users, we take away the ones that are not in your chosen categories. <br />
                                             ...
                                             It is highly probable that the user counts could change. Please <a class="AddLink" target="_blank" href="About.aspx#UserCalculation">read the full algorithm </a>of how this count is calculated, and
                                        ...
                                        <%--<hr />--%>
                                        <div style="line-height: 20px; display: none;">
    ...
    This number is a count of the users on record with us who match the location and categories you have specified. We cannot provide the actual number of users who will see your ad for a several reasons: We cannot say how many people will log into the site; we cannot control how many users change their category preferences for viewing ads; new users who fit your criteria might register with the site after you post your ad; and existing users could already have too many ads assigned to them. This is explained more comprehensively on the <a class="AddLink" href="About.aspx">About page.</a>
                                       ...
                                       <label> additional users will potentially see your ad if they have no other ads to see because they are in your specific chosen location.</label>
                                        ...
                                        <%--<hr />--%>
                                            ...
                                            <span style="font-weight: bold;"><span style='color: #1fb6e7; font-weight: bold;'>* </span>Choose the Number of Views</span></label>
                                            ...
                                            <asp:Image CssClass="HelpImage" runat="server"  ID="Image6" ImageUrl="~/image/helpIcon.png"></asp:Image>
                                                                    ...
                                                                    <rad:RadToolTip ID="RadToolTip11" runat="server" Skin="Black" Width="300px" Height="200px" ManualClose="true" ShowEvent="onclick" Position="MiddleRight" RelativeTo="Element" TargetControlID="Image6">
                                                        ...
                                                        <td>
                                                            ...
                                                            <%--<tr>
                                                                ...
                                                                <rad:RadToolTip ID="RadToolTip1" runat="server" Skin="Black" Width="200px" Height="200px" ManualClose="true" ShowEvent="onclick" Position="MiddleRight" RelativeTo="Element" TargetControlID="QuestionMark2">
                                                                    ...
                                                                    An ad can only be refunded if it falls under the </label><a class="AddLink" href=\"AdTermsAndConditions.aspx\">Refund Terms and Conditions</a>.
                                                                        </rad:RadToolTip>
                                ...
                                <asp:Panel runat="server" ID="Panel13" DefaultButton="CategoryOnwardButton">          
                                    ...
                                    <div class="EventDiv" style="background: url('image/TabsBackground.png'); background-repeat: repeat-y;  width: 668px;">
                                        <div style="padding-left: 30px; width: 550px; padding-top: 10px;">
                                            <h1>Payment Info</h1>
                                            <asp:Panel runat="server" ID="FeaturedPayAdPanel">
                                            </asp:Panel>
                            ...
                            <rad:RadPageView runat="server" ID="TabSix" TabIndex="6" >
                                ...
                                <div class="topDiv" style=" position: relative;">
                                    <div align="center" id="Div2"  style="display: none;z-index: 3000; padding-left: 30px;margin-top: 50px; position: absolute; width: 400px; height: 200px;margin-left: -20px;" >
                                ...
                                <asp:Panel runat="server" ID="Panel5" DefaultButton="PostItButton"> 
                                    ...
                                    <div class="EventDiv"  style="background: url('image/TabsBackground.png'); background-repeat: repeat-y; width: 668px;">
                                        ...
                                        <div style="padding-left: 20px;">
                                          <label><span style="font-weight: bold;">You're Almost Done!</span> <br /> 
                                          <span style='color: #ff770d;'>Preview your post below and read the Terms and Conditions. Go Backwards! if you'd like to change anything!</span></label>
                                            <asp:Panel runat="server" ID="FeaturedWeWouldPanel">
                                            <br /><br /><label>In an effort to save our users a view, the user whom posted the ad will not see it in their ad rotation nor in their saved ad search emails.</label>
                                        </asp:Panel>
                                        </div>
                                        <div style="padding-left: 20px;">
                                            <br />
                                ...
                                <asp:Panel runat="server" CssClass="TermsPanel"  ScrollBars="Vertical" ID="TACTextBox" Height="100px" Width="550px"></asp:Panel>
                                        ...
                                        <div align="right" style=" padding-top: 30px; padding-right: 50px;">
                                            ...
                                            onmouseout="this.src='image/BackwardsButton.png'" onmouseover="this.src='image/BackwardsButtonSelected.png'"  />
                                            <asp:ImageButton OnClientClick="ShowLoadingCalendar()" runat="server" ID="PostItButton" OnClick="PostIt" ImageUrl="image/PostItButton.png" 
