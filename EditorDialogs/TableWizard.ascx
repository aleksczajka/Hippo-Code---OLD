...
Telerik.Web.UI.Widgets.TablePreview.prototype = {
	...
	{
		return (cell.className == "selectedCell"); // Or use the this.selectedCells Array ?
	},
...
Telerik.Web.UI.Widgets.TableWizard.prototype = {
	 ...
	 _insertClickHandler : function(e)
    {
		...
		Telerik.Web.UI.Dialogs.CommonDialogScript.get_windowReference().close({tableToModify : this._getModifiedTable() });
    },
	...
	_synchronizeSelectedCell : function()
	{
		...
		for (var i=0; i<previewTableRows.length; i++)
		{
			...
			for (var j=0; j<previewTableCells.length; j++)
			{
				...
				{
					this._selectedCell = this._table.rows[i].cells[j];
	...
	*/
	_getModifyCellForPreviewCell : function(previewCell)
	{
		...
		return this._table.rows[rowIndex].cells[cellIndex];
	},
...
.rade_dialog .spinList
{
    height: 26px;
}

.rade_dialog .spinItem span
{
    line-height: 26px;
}
/*.rade_dialog.reTableWizard
{
	height: 420px;
	float: left;
}

*+html .rade_dialog.reTableWizard
{
	height: 410px;
}

.rade_dialog.reTableWizard .dialogtabstrip
{
	width: 653px;
}

.rade_dialog.reTableWizard .dialogtabstrip .tabIcon
{
	display: none;
}

.rade_dialog.reTableWizard .customControl .rade_toolbar,
.rade_dialog.reTableWizard .customControl .rade_toolbar li
{
	background: none;
}

.rade_dialog.reTableWizard .rade_colorPickerContainer li,
.rade_dialog.reTableWizard .rade_alignmentContainer li
{
	height: 24px !important;
	line-height: 24px;
}

.rade_dialog.reTableWizard .customControl .rade_grip
{
	display: none;
}

.rade_dialog.reTableWizard #tableWizardControlButtons
{
	position: absolute;
	bottom: 0;
	left: 17px;
...
.rade_dialog.reTableWizard #tableWizardControlButtons .floatright
{
	margin: 8px 0 0;
	padding: 0;
}

.rade_dialog.reTableWizard #tableWizardControlButtons legend
{
	display: none;
}

.rade_dialog.reTableWizard #tableWizardControlButtons ul
{
	list-style-type: none;
	width: 150px;
}

.rade_dialog.reTableWizard table.tableDesignPreview
{
	border: 0;
	background: #b0b0b0;
	empty-cells: show;
...
.rade_dialog.reTableWizard table.tableDesignPreview td
{
	background: #ececec;
	padding: 0; margin: 0;
	cursor: pointer;
...
.rade_dialog.reTableWizard table.tableDesignPreview td.reSelectedCell
{
	background: #cecece;
...
<!-- table wizard -->
<table cellpadding="0" cellspacing="0" class="rade_dialog TableWizard" style="width: 100%;">
	<tr>
		<td class="rade_topcell">
			<telerik:RadTabStrip ID="TableWizardTab" runat="server" SelectedIndex="0" MultiPageID="dialogMultiPage">
				<Tabs>
					<telerik:RadTab Text="Table Design" Value="TableDesign">
					</telerik:RadTab>
					<telerik:RadTab Text="Table Properties" Value="TableProperties">
					</telerik:RadTab>
					<telerik:RadTab Text="Cell Properties" Value="CellProperties">
					</telerik:RadTab>
					<telerik:RadTab Text="Accessibility" Value="Accessibility">
					</telerik:RadTab>
				</Tabs>
			</telerik:RadTabStrip>
		</td>
	...
	<tr>
		<td class="rade_middlecell" style="height: 400px; padding: 0; vertical-align: top;">
	...
	<tr>
		<td class="rade_bottomcell" style="padding-right: 8px; padding-top: 4px;">
