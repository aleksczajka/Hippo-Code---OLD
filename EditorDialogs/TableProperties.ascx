...
Telerik.Web.UI.Widgets.TableProperties.prototype = {
	...
	clientInit : function(clientParameters)
	{
		...
		if(clientParameters)
		{
		    if(!this._table) this._table = clientParameters.tableToModify;  
		}
	...
	_loadData : function()
	{
	    if(this._table)
	    {
	        ...
	        this._tableWidth = this._table.style.width ? this._table.style.width : (this._table.width ? this._table.width : "");	            
	        this._spinBoxWidth.set_value(this._tableWidth);
	        
	        this._tableHeight = this._table.style.height ? this._table.style.height : (this._table.height ? this._table.height : "");	            
...
<table cellpadding="0" cellspacing="0" style="width: 706px;">
    <tr>
        <td style="padding: 0;">
            <fieldset style="margin: 4px; margin-top: 0;">
                <legend>
                    <script type="text/javascript">
                    document.write(localization["Dimensions"]);
                    </script>
                </legend>
        ...
        <td rowspan="2" style="vertical-align: top; padding: 0;">
            <fieldset style="margin: 4px; margin-top: 0; margin-left: 6px; height: 380px;">
    ...
    <tr>
        <td style="padding: 0;">
			<fieldset style="margin: 4px; margin-top: 0; height: 298px;">
                <legend>
                    <script type="text/javascript">
                    document.write(localization["Layout"]);
                    </script>
                </legend>
                <table cellpadding="0" cellspacing="0" class="tableWizardLayout" style="margin-top: 20px;">
                    <tr>
                        <td style="padding: 3px 0;">
                            <div class="propertyLabel" style="width: 104px;">
                                <script type="text/javascript">
                    ...
                    <tr>
                        ...
                        <td style="padding: 3px 0;">
                            <tools:ApplyClassDropDown id="ClassSelector" runat="server"></tools:ApplyClassDropDown>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 3px 0;">
                    ...
                    <tr>
                        <td style="padding: 3px 0;">
                            <div class="propertyLabel" style="width: 104px;">
                                <script type="text/javascript">
                                document.write(localization["Alignment"]);
                                </script>:
                            </div>
                        </td>
                        <td style="padding: 3px 0;">
                            <tools:AlignmentSelector id="AlignmentSelectorTable" runat="server"></tools:AlignmentSelector>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 3px 0;">
                            <div class="propertyLabel" style="width: 104px;">
                                <script type="text/javascript">
                                document.write(localization["CellSpacing"]);
                                </script>:
                            </div>
                        </td>
                        <td style="padding: 3px 0;">
                            <tools:EditorSpinBox id="SpinBoxCellSpacing" runat="server"></tools:EditorSpinBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 3px 0;">
                            <div class="propertyLabel" style="width: 104px;">
                                <script type="text/javascript">
                                document.write(localization["CellPadding"]);
                                </script>:
                            </div>
                        </td>
                        <td style="padding: 3px 0;">
                            <tools:EditorSpinBox id="SpinBoxCellSPadding" runat="server"></tools:EditorSpinBox>
                        </td>
                    </tr>
                </table>
            </fieldset>
