...
Telerik.Web.UI.Widgets.MediaPreviewer = function(element)
{
	...
	this._mediaPropertiesPane = null;
	this._mediaPreviewPane = null;
...
Telerik.Web.UI.Widgets.MediaPreviewer.prototype = {
	...
	{
		this._toolbar = $find("MediaPreviewToolBar");
		
		this._mediaPropertiesPane = $get("mediaPropertiesPane");
		this._mediaPreviewPane = $get("mediaPreviewPane");
	...
	_toolbarClickHandler : function(sender, args)
	{
		...
		{
			case "Properties":
				if(this._currentItem && this._mediaPropertiesPane.style.display == "none")
				{
					if(this._currentMediaItem)
					{
						this._mediaPreviewPane.innerHTML = "";
						this._currentMediaItem = null;
					}
			...
			break;
			case "Preview":
				if(this._currentItem && this._mediaPreviewPane.style.display == "none")
				{
					//The timeout is necessary in order for the movie to play in IE6.
					var thisObject = this; 
					setTimeout(function()
						{
							thisObject._mediaPreviewPane.innerHTML = thisObject._createMediaElement();
						}
						, 0);
    ...
    _getParams : function(element)
    {
        ...
        if (element == "object")
        {
            params["FileName"] = this._currentItem.getUrl();
        }
        else
        {
    ...
    _getObjectAttributes : function()
    {
        ...
        {
            objectParams["classid"] = "clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95";
        }
...
//        }
	...
	{
	    this._mediaPreviewPane.style.display = previewMode;
	    this._mediaPropertiesPane.style.display = propertiesMode;
	},
	...
	setItem : function(item)
	{
	    ...
	    if (item.type == Telerik.Web.UI.Widgets.FileItemType.Directory)
	    {
		    ...
		    this._currentItem = null;
		    this._mediaPreviewPane.style.display = "none";
	        this._mediaPropertiesPane.style.display = "none";
	    }
	    else
	    {
    ...
    _createRadio : function(id, radioValue, defaultValue)
    {
	    ...
	    if (document.all)
	    {
		    radioBox = document.createElement("<INPUT NAME='booleanGroup'" + ((radioValue == defaultValue.toString()) ? " CHECKED" : "") + ">");
	    }
	    else
	    {
...
Telerik.Web.UI.Editor.DialogControls.MediaManager = function(element)
{
	Telerik.Web.UI.Editor.DialogControls.MediaManager.initializeBase(this, [element]);
}

Telerik.Web.UI.Editor.DialogControls.MediaManager.prototype = {
	initialize : function() 
	{
		this.set_insertButton($get("InsertButton"));
		this.set_cancelButton($get("CancelButton"));
		
		$create(Telerik.Web.UI.Widgets.MediaPreviewer, null, null, null, $get("MediaPreviewer"));
		this.set_filePreviewer($find("MediaPreviewer"));
		this.set_toolbar($find("fileManagerToolBar"));
		this.set_fileLister($find("GenericFileLister1"));
		
		Telerik.Web.UI.Editor.DialogControls.MediaManager.callBaseMethod(this, 'initialize');
	},

	dispose : function() 
	{
		Telerik.Web.UI.Editor.DialogControls.MediaManager.callBaseMethod(this, 'dispose');
		this._insertButton = null;
		this._cancelButton = null;
	}
}

Telerik.Web.UI.Editor.DialogControls.MediaManager.registerClass('Telerik.Web.UI.Editor.DialogControls.MediaManager', Telerik.Web.UI.Widgets.FileManager);
</script>

<!-- Media Manager Dialog Begin -->
<table class="rade_dialog ManagerDialog MediaManager" border="0" cellpadding="0"
	...
	<tr id="listRow">
		...
		<td style="width: 50%; padding: 0; vertical-align: top;">
			<div id="MediaPreviewer" class="propertiesTableCell">
				<telerik:RadToolBar ID="MediaPreviewToolBar" runat="Server">
					<Items>
						<telerik:RadToolBarButton CssClass="NoIcon" Text="Properties" ToolTip="Properties" Value="Properties" CheckOnClick="true" AllowSelfUncheck="true" Checked=true />
						<telerik:RadToolBarButton Text="Preview" CssClass="NoIcon" ToolTip="Preview" Value="Preview" CheckOnClick="true" AllowSelfUncheck="true" />
					</Items>
				</telerik:RadToolBar>
				<div class="mediaPropertiesPane" id="mediaPropertiesPane" style="display: none;">
					<fieldset style="margin: 0 4px; height: 290px;">
							<legend>Media Properties</legend>
							<table border="0" cellpadding="0" cellspacing="0" width="100%" class="propertiesList">
								<tr>
									<td style="text-align: right;">
										<input type="checkbox" id="ClassID" style="border: 0; margin-right: 8px;" />
									</td>
									<td>
										<label for="ClassID" class="propertyLabel" style="text-align: left">
											<script type="text/javascript">
								...
								<tr id="ClassIDLi" style="display: none;">
									<td>
										<label for="ClassIDText" class="propertyLabel" style="width: 65px;">
											<script type="text/javascript">
									...
									<td>
										<input type="text" class="textinput" id="ClassIDText" style="width: 240px;" />
									</td>
								</tr>
								<tr>
									<td>
										<label for="mediaWidth" class="propertyLabel" style="width: 65px;">
											<script type="text/javascript">
									...
									<td>
										<input type="text" id="mediaWidth" style="width: 236px;" />
									</td>
								</tr>
								<tr>
									<td>
										<label for="mediaHeight" class="propertyLabel" style="width: 65px;">
											<script type="text/javascript">
									...
									<td>
										<input type="text" id="mediaHeight" style="width: 236px;" />
									</td>
								</tr>
								<tr>
									<td>
										<label for="mediaAlign" class="propertyLabel" style="width: 65px;">
											<script type="text/javascript">
									...
									<td>
										<select id="mediaAlign" style="width: 246px;">
								...
								<tr>
									<td>
										<label for="mediaProperties" class="propertyLabel" style="width: 65px;">
											<script type="text/javascript">
									...
									<td>
										<select id="mediaProperties" style="width: 246px;">
								...
								<tr>
									<td>&nbsp;</td>
									<td>
										<label id="propertyValueDescription" style="width: 254px;text-align: left">
								...
								<tr>
									...
									<td>
										<style type="text/css">
										#propertyValuePane input[type="radio"]
										{
											border: 0;
										}
										</style>
				...
				<div class="mediaPreviewPane" id="mediaPreviewPane" style="display: none;"></div>
			</div>
		</td>
	</tr>
