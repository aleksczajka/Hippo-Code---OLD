...
<table cellpadding="0" cellspacing="0" style="margin: 0 0 0 4px; width: 700px;">
    <tr>
        <td>
            <fieldset style="height: 382px;">
                <legend>Accessibility Options</legend>
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding: 3px 0;">
                            <label class="propertyLabel" for="headingRows">
                                <script type="text/javascript">
                                document.write(localization["HeadingRows"]);
                                </script>:    
                            </label>
                        </td>
                        <td style="padding: 3px 0;">
                            <input type="text" id="headingRows" class="s_input" />
		                    <span id="maxHeadRows"><!-- / --></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 3px 0;">
                            <label class="propertyLabel" for="headingColumns">
                                <script type="text/javascript">
                    ...
                    <tr>
                        <td style="padding: 3px 0;">
                            <label class="propertyLabel" for="CaptionText">
                               <script type="text/javascript">
                        ...
                        <td style="padding: 3px 0;">
                            <textarea id="CaptionText" rows="6" cols="10" class="l_input" style="border-style: solid; overflow: auto; width: 540px;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 3px 0;">
                    ...
                    <tr>
                        <td style="padding: 3px 0;">
                            <label for="accessibilitySummary" class="propertyLabel">
                                <script type="text/javascript">
                        ...
                        <td style="padding: 3px 0;">
                            <textarea id="SummaryText" rows="6" cols="10" class="l_input" style="border-style: solid; overflow: auto; width: 540px;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 3px 0 3px 134px;">
