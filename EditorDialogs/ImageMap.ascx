...
Telerik.Web.UI.Editor.DialogControls.ImageMapDialog.prototype =
{
    ...
    initializeImageDialogCaller: function(clientParameters) 
    {
        ...
        this._imageCaller.set_editor(clientParameters._editor);
...
<table cellpadding="0" cellspacing="0" class="rade_dialog ImageMapEditor" style="width: 100%;
	margin: 4px; margin-top: 0;">
	<tr>
				...
				<tr>
					<td style="padding: 0;">
						<fieldset id="map_props">
							...
							<table cellpadding="0" cellspacing="0" class="DefineAreaProperties">
								<tr>
									...
									<td>
										<input type="text" id="ImageMap_AreaLeft" style="width: 40px;" /> px
									</td>
									<td>
									...
									<td>
										<input type="text" id="ImageMap_AreaTop" style="width: 40px;" /> px
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" id="ImageMap_AreaWidth" style="width: 40px;" /> px
									</td>
									<td>
									...
									<td>
										<input type="text" id="ImageMap_AreaHeight" style="width: 40px;" /> px
									</td>
								</tr>
							</table>
							<table cellpadding="0" cellspacing="0" class="DefineAreaProperties">
								<tr>
									...
									<td>
										<input type="text" id="ImageMap_AreaURL" style="width: 234px;" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<select id="ImageMap_AreaTarget" style="width: 240px;">
								...
								<tr>
									...
									<td>
										<input type="text" id="ImageMap_AreaComment" style="width: 234px;" />
									</td>
								</tr>
							</table>
						</fieldset>
						<fieldset>
							...
							<button type="button" id="ImageMap_UpdateArea" style="margin-right: 4px;">
								<script type="text/javascript">
								setInnerHtml("ImageMap_UpdateArea", localization["UpdateArea"]);
								</script>
							</button>
							<button type="button" id="ImageMap_RemoveArea" style="margin-right: 4px;">
								<script type="text/javascript">
						...
						<table cellpadding="0" cellspacing="0" style="width: 100%">
							<tr>
								<td class="rade_bottomcell" colspan="2" style="text-align: right; padding: 4px 2px 0 0;">
									<button type="button" id="ImageMap_OK" style="width: 100px; margin-right: 4px;">
										<script type="text/javascript">
										setInnerHtml("ImageMap_OK", localization["OK"]);
										</script>
									</button>
									<button type="button" id="ImageMap_Cancel" style="width: 100px;">
										<script type="text/javascript">
