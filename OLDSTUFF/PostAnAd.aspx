...
--%>            <div style="margin-top: 40px; padding-left: 5px; margin-left: 30px;font-family: Arial; 
            font-size: 12px; color: White;background: url('image/FeaturedBackground.png'); width: 700px; 
                                    ...
                                    <div id="topDiv3" style="background: url('image/TabsBackground.png'); background-repeat: repeat-y; width: 668px; padding-top: 10px;">
                                        <div class="EventDiv" style="padding-left: 30px; float: left; padding-bottom: 10px; margin-right: 50px;">
                                            ...
                                            <div id="topDiv" style="padding-left: 20px;">
                                                ...
                                                <label>All HTML tags will be removed except for links and line breaks. However, the header cannot contain any html.</label>
                                                <br /><br />
...
--%>                                                         <%-- <rad:RadEditor OnClientLoad="OnClientLoad" EditModes="Design" Skin="Black" runat="server" 
                                                    ...
                                                    <script type="text/javascript">
                                                        Telerik.Web.UI.Editor.CommandList["InsertLink"] = function(commandName, editor, args)
                                                        {
                                                          ...
                                                          {
                                                              editor.pasteHtml(String.format("<a target='_blank' class='AddLink' href='{1}'>{0}</a>", args.url, args.name))
                                                          }
                                            ...
                                            <div style="padding-left: 30px; width: 632px; clear: both; padding-top: 10px;">
                                                ...
                                                <h1>Ad Media</h1>
                                                    <div style="margin-left: 20px;">
                                                        ...
                                                        ID="BannerAdCheckBox" Text="Include a Banner Image <span style='color: #ff770d;'>[will be sized to fit 100px by 100px]</span>" />
                                                    </div>
...
//                                                                            }  
                                                            ...
                                                            max 250 characters &nbsp;&nbsp;&nbsp;<span style="color: Red;" id="CharsDiv"></span></span>
                                                            <br />
                                    ...
                                    <div class="EventDiv" style="background: url('image/TabsBackground.png'); background-repeat: repeat-y;  width: 668px;">
                                      ...
                                      <Triggers>
                                       ...
                                       <div>
                                            ...
                                            <h1 style="font-family: Arial; font-size: 20px; color: #ff770d;">Select your Ad Placement</h1></label>
                                            </div>
                                            <div style="float: left;">
