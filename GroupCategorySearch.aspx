...
CodeFile="GroupCategorySearch.aspx.cs" Inherits="GroupCategorySearch" Title="Group Category search | HippoHappenings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="EventDiv" style="float: left;"><h1 style="margin: 0;"><asp:Label Width="418px" runat="server" CssClass="EventHeader" ID="SearchResultsTitleLabel"></asp:Label></h1>
            ...
            <ctrl:GroupSearchElements runat="server" ID="SearchElements" />
        </div>
