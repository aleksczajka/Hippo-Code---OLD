<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnableEvent.aspx.cs" Inherits="EnableEvent" %>
...
<body>
    ...
    <asp:Panel ID="RemovePanel" runat="server">  
                         ...
                         <table cellpadding="0" cellspacing="0" style="padding-top: 10px;">
                            <tr>
                                <td colspan="2" align="center">
                                    <label> Are you sure you want to re-enable this event? <br />
                                     </label>
                                     <br /><br />
                                </td>
                            </tr>
                            <tr>
                             ...
                             <ctrl:BlueButton CLIENT_CLICK="Search()" runat="server" ID="BlueButton3" BUTTON_TEXT="Forget It" />
                            </td>
                            <td align="left" style="padding-left: 5px;">
                            <ctrl:BlueButton runat="server" ID="BlueButton1" BUTTON_TEXT="Yes" />
                        </td>
                ...
                <div class="EventDiv" align="center" style="padding-top: 20px;">
                    <label>Your event has been enabled!</label>
                    <br /><br />
                    <ctrl:BlueButton runat="server" ID="BlueButton2" BUTTON_TEXT="Done" CLIENT_CLICK="Search('something');" />
                </div>
            </asp:Panel>
                     </div>  
