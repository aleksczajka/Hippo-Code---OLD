<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisableVenue.aspx.cs" Inherits="DisableVenue" %>
...
<body>
    ...
    <asp:Panel ID="RemovePanel" runat="server">  
                         ...
                         <table cellpadding="0" cellspacing="0" style="padding-top: 10px;">
                            <tr>
                                <td colspan="2" align="center">
                                    <label> Are you sure you want to disable this venue for now? <br />
                                     </label>
                                     <br /><br />
                                </td>
                            </tr>
                ...
                <div class="EventDiv" align="center" style="padding-top: 30px;">
                    <label>Your venue has been disabled!</label>
                    <br /><br /><br /><br />
                    <ctrl:BlueButton CLIENT_CLICK="Search()" runat="server" ID="BlueButton2" BUTTON_TEXT="Done" />
