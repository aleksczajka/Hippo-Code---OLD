<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnableVenue.aspx.cs" Inherits="EnableVenue" %>
...
<body>
    ...
    <asp:Panel ID="RemovePanel" runat="server">  
                         ...
                         <table cellpadding="0" cellspacing="0" style="padding-top: 10px;">
                            <tr>
                                <td colspan="2" align="center">
                                    <label> Are you sure you want to re-enable this venue? <br />
                                     </label>
                                     <br /><br />
                                </td>
                            </tr>
                ...
                <div class="EventDiv" align="center" style="padding-top: 30px;">
                    <label>Your venue has been enabled!</label>
                    <br /><br /><br /><br />
