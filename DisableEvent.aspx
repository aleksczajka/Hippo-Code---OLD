<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisableEvent.aspx.cs" Inherits="DisableEvent" %>
...
<body>
    ...
    <asp:Panel ID="RemovePanel" runat="server">  
                         ...
                         <table cellpadding="0" cellspacing="0" style="padding-top: 10px;">
                            <tr>
                                <td colspan="2" align="center">
                                    <label> Are you sure you want to disable this event for now? <br />
                                     </label>
                                     <br /><br />
                                </td>
                            </tr>
                ...
                <div class="EventDiv" align="center" style="padding-top: 20px;">
                    <label>Your event has been disabled!</label>
                    <br /><br />
                    <ctrl:BlueButton CLIENT_CLICK="Search('something')" runat="server" ID="BlueButton3" BUTTON_TEXT="Done" />
                </div>
            </asp:Panel>
                     </div>  
