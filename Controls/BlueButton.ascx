<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlueButton.ascx.cs" Inherits="BlueButton" %>
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top">
                    ...
                    src="http://hippohappenings.com/NewImages/ButtonLeft.png" height="27px" />
                </td>
                <td valign="top">
                    <div class="BlueButtonTop">
                ...
                <td valign="top">
                    <img alt="Background Image" src="http://hippohappenings.com/NewImages/ButtonRight.png" height="27px" />
                </td>
            </tr>
        </table>
