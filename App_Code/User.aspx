...
//            }
   ...
   <telerik:RadWindowManager ShowContentDuringLoad="true" VisibleTitlebar="true" 
        ...
        <div style="float: left; width: 420px; padding-bottom: 15px;margin-top: -20px;">
            <div id="ImageDiv" style="width: 50px;" runat="server"><asp:Image runat="server" ToolTip="What's this page for?" CssClass="HelpImage" 
            ...
            <h1 class="EventHeader" style="margin: 0;">Welcome <asp:Label runat="server" ID="UserLabel"></asp:Label>!</h1>
                                <asp:Label runat="server" ForeColor="Red" ID="UserErrorLabel"></asp:Label>     
            <div style="padding-bottom: 10px;">
            <span style="font-family: Arial; font-size: 20px; color: White; font-weight: bold; padding-right: 20px;">Your Week at a glance</span>
            <asp:HyperLink runat="server" ID="CalendarLink" CssClass="SmallLink">(View Full Calendar)</asp:HyperLink>
         </div>   
   ...
   <div style="width: 900px; display: block;" >
    <rad:RadTabStrip Width="280px" Orientation="VerticalLeft" Align="right" ID="RadTabStrip2" Skin="Black"
                        ...
                        </rad:RadTabStrip><rad:RadMultiPage ID="TheMultipage" 
                         SelectedIndex="0" runat="server" >
                            <rad:RadPageView ID="Tab1" runat="server" >
                                <div style="height: 45px; margin-top: 1px; background-color: #363636; width: 7px; float: left;"></div>
                            ...
                            <rad:RadPageView ID="Tab2" runat="server" >
                                ...
                                <asp:Panel runat="server" ID="FriendPanel">
                                    <div class="topDiv">
                                    <div style="height: 45px; margin-top: 47px; background-color: #363636; 
                                    width: 7px; float: left;"></div>
                                    <div style="border: solid 3px #363636; margin-top: 1px; float: left; width: 570px;">
                                    ...
                                    <div style="width: 570px;clear: both;">
                                        <asp:Panel BorderColor="#1fb6e7"  CssClass="SayFriendPanel FloatRight" BorderStyle="solid" BorderWidth="2px" 
                                        Height="100px" ScrollBars="Vertical" Width="300px" runat="server" ID="WhatMyFriendsDidPanel"></asp:Panel>
                                    </div>
                                    <div class="topDiv" style="width: 560px; background-color: #363636; display: block; float: left; clear: both; margin-left: 5px; margin-bottom: 5px; padding-bottom: 5px;">
                                    <asp:Panel Width="560px" ID="MyFriendsPanel" runat="server">
                                    <%--<div align="right" style="padding-right: 5px; padding-bottom: 5px;">
                                        <asp:Panel Width="300px" BackColor="#666666" runat="server" ID="SearchFriendPanel" Visible="false">
                                            <div align="left">
                            ...
                            <a id="pfs"></a>
                                <div style="height: 45px; margin-top: 93px; background-color: #363636; width: 7px; float: left;"></div>
                                <div style="border: solid 3px #363636; margin-top: 1px; float: left; width: 570px;">
 ...
 /></div>
                                        <div class="Prefs EventDiv" style="width: 560px; display: block; float: left; margin-left: 5px; padding-top: 5px;">
                                            ...
                                            <div style="border-bottom: dotted 1px black;">
                                                ...
                                                <span style="font-style: italic; font-family: Arial; font-size: 14px; color: #666666;"> (Events and Ads on 
                                            ...
                                            <div style="border-bottom: dotted 1px black;">
                                                <asp:Label ID="Label1" runat="server" Text="Profile Preferences" CssClass="PreferencesTitleAlt"></asp:Label>
                                            </div>
                                            <div style="clear: both;"  class="Pad">
                                                <div style="float:left;">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label2" runat="server" Text="Communication Preferences" CssClass="PreferencesTitle"></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                            ...
                                            AllowCollapseAllItems="true"  runat="server" ID="AdCategoryRadPanel">
                                                    <Items>
                                                        <telerik:RadPanelItem SelectedCssClass="" Text="<div style='cursor: pointer;'><label style='cursor:pointer;' ID='Label12' class='PreferencesTitleAlt'>Ad Category Interests <span style='font-style: italic; font-family: Arial; font-size: 14px; color: #666666;'>(Ads throughout the site will be filtered based on the categories you select here.)</span></label></div>" Height="60px" CssClass="VenueCheckBoxes" Expanded="false">
                                                            <Items>
                                            ...
                                            <div  class="Pad">
                                                <div style="padding-left: 40px;">
                                                     <span style="width: 300px; font-family: Arial; font-size: 14px; color: #666666;">
                                                     *You can also receive email with featured ads matching your criteria by going to 
                                                     <a class='AddLin' href='ad-search'>Ads & Classifieds</a> and creating a saved search.</span><br /><br />
                                                     <span style="width: 300px; font-family: Arial; font-size: 14px; color: #666666;">
                                ...
                                <table height="100%">
                                           ...
                                           <%-- <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both;">
                                                <asp:Label ID="Label3" runat="server" CssClass="PreferencesTitleAlt"> Event Recommendations Preferences <span style="font-style: italic; font-family: Arial; font-size: 14px; color: #666666;">(Show recommend events in the <b>User Page</b> and in the <b>Footer</b> when they are ...)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label6" runat="server" CssClass="PreferencesTitleAlt"> Texting Preferences <span style="font-style: italic; font-family: Arial; font-size: 14px; color: #666666;">(send notifications to your phone when...)</span></asp:Label>
                                            </div>
                                            <div  class="Pad">
                                            ...
                                            <div style="border-bottom: dotted 1px black; clear: both; padding-top: 10px;">
                                                <asp:Label ID="Label10" runat="server" CssClass="PreferencesTitle"> Email Preferences <span style="font-style: italic; font-family: Arial; font-size: 14px; color: #666666;">(send notifications to your email address when...)</span></asp:Label>
                                            </div>
                                            ...
                                            <div  class="Pad">
                                               ...
                                               <asp:TextBox runat="server" BackColor="#666666" BorderColor="#1b1b1b"  ID="EmailTextBox" Width="200px" />
                                                ...
                                                <br />
                                                <label>User Generated Emails</label>
                                            ...
                                            <asp:Button runat="server" ID="SearchButton" Text="Save Changes" CssClass="SearchButton" OnClick="Save"
onmouseout="this.style.backgroundImage='url(image/PostButtonNoPost.png)'" 
                                onmouseover="this.style.backgroundImage='url(image/PostButtonNoPostHover.png)'"
 onclientclick="this.value = 'Working...';" 
 /></div>
    ...
    <div >
        ...
        <rad:RadTabStrip runat="server" ID="RadTabStrip1" Orientation="HorizontalTop"
                ...
                <Tabs>
                    <rad:RadTab Text="New Events">
                    </rad:RadTab>
                    <rad:RadTab Text="Favorite Venues">
                    </rad:RadTab>
                </Tabs>
            </rad:RadTabStrip><rad:RadMultiPage runat="server" ID="RadMultiPage1" BackColor="#363636" SelectedIndex="0" 
                Width="280px"><rad:RadPageView  runat="server" ID="RadPageView1">
                ...
                <rad:RadPageView runat="server" ID="RadPageView2">
                    <asp:Panel Wrap="true" runat="server" Width="260px" ID="FavoriteVenues" CssClass="FavoritesPanel"></asp:Panel>
                </rad:RadPageView>
            </rad:RadMultiPage>
        </div>
    </div>
