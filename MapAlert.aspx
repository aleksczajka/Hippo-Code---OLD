...
<%@ OutputCache Duration="86400" VaryByParam="*" NoStore="true" %>
        ...
        geocoder.getLatLng(
          ...
          function(point) {
            if (!point) 
            {
              ...
              marker.openInfoWindowHtml("<div class='NavyLink12'>"+getCookie('addressParameterName') +'<br/>'+ address.replace(/@&/g, "<br/>")+"</div>");
            }
          }
        );
      }
        ...
        <table width="700px" height="490px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding-bottom: 10px;">
                    <label>Directions From: </label><input onkeypress="{if (event.keyCode==13)GoToDirections();}" type="text" id="FromInput" maxlength="100" />
                ...
                <td align="right" style="padding-bottom: 7px; margin: 0;">
                    <a class="NavyLink12" onclick="window.print();" style="text-decoration: underline;">print</a>
                    &nbsp;&nbsp;&nbsp;
                    <a class="NavyLink12" onclick="Search();" style="text-decoration: underline;">close</a>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <div id="map_canvas" style="width: 680px; height: 460px; display: block;"></div>
                </td>
            </tr>
        </table>
