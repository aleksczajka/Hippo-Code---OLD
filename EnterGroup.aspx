    ...
    <asp:Panel runat="server" ID="LoggedOutPanel">
        <div id="topDiv5">
            <div style="float: left; width: 390px;">
                            ...
                            <span style="font-family: Arial; font-size: 30px; color: White;">Enter Group</span>
                    ...
                    <div style="background: url('image/TabsBackground.png'); background-repeat: repeat-y;width: 668px;">
                        ...
                        <div class="EventDiv">
                           <div style="padding-left: 30px; width: 622px; clear: both; padding-top: 10px;" class="topDiv">
                               ...
                               <br />
                               <asp:CheckBox runat="server" ID="AutomaticCheckBox" Text="Let Everyone's (invited and non-invited) Membership be Automatically Accepted" />
                               <br />
                               <asp:CheckBox runat="server" ID="AutomaticHostCheckBox" Text="Let Everyone Who is Automatically Accepted be a Shared Host" />
...
<table>
                        ...
                        <div style="padding-left: 30px; width: 550px; clear: both;">
                            ...
                            <div style="padding-top: 16px; float: left; padding-left: 10px;">
                                <asp:LinkButton runat="server" CssClass="AddLink" Text="Suggest" ID="ImageButton11" OnClick="SuggestCategoryClick"
                                                            onmouseout="this.src='image/MakeItSoButton.png'" 
